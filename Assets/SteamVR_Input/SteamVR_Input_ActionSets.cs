...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_DirectControl p_DirectControl;
        ...
        public static SteamVR_Input_ActionSet_DirectControl DirectControl
        {
            get
            {
                return SteamVR_Actions.p_DirectControl.GetCopy<SteamVR_Input_ActionSet_DirectControl>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_DirectControl = ((SteamVR_Input_ActionSet_DirectControl)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_DirectControl>("/actions/DirectControl")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.DirectControl};
        }
    }
}
